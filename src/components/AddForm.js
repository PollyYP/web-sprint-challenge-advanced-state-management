...
import { setErrorMessage, addNewSmurf } from "../actions/index";
...
const AddForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (input.name === "" || input.position === "" || input.nickname === "") {
      setErrorMessage(dispatch);
    } else {
      addNewSmurf(dispatch, input);
      setInput({
        name: "",
        position: "",
        nickname: "",
...
//2. Replace all instances of the errorMessage static variable with your error message smurfs value.
